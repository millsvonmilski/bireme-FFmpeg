...
./configure --enable-debug --disable-optimizations --disable-vda --disable-videotoolbox --disable-decoder=aac,mp3,h264,aac_mf_audio,mp3_mf_audio,h264_mf_video --enable-decoder=aac_audiotoolbox,mp3_audiotoolbox,h264_videotoolbox --prefix=/Users/xxx/Temp/ffmpeg

# full config without debug
./configure --disable-vda --disable-videotoolbox --disable-decoder=aac,mp3,h264,aac_mf_audio,mp3_mf_audio,h264_mf_video --enable-decoder=aac_audiotoolbox,mp3_audiotoolbox,h264_videotoolbox --prefix=/Users/xxx/Temp/ffmpeg
...
---------------------
 ...
 Debugging
----------
Edit the debug configuration to set the 'Command' setting to your built copy of ffplay (ex: C:\Users\xxx\Temp\ffmpeg\bin\ffplay.exe) and 'Command Arguments' to the file you want to play.
